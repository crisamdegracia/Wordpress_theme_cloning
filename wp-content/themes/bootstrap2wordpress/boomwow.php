...
<style type="text/css">
    ...
    .switcher .selected {
        background: #FFFFFF url(//localhost/wp-content/plugins/gtranslate/switcher.png)repeat-x;
        position: absolute;
    ...
    .switcher .selected a {
        ...
        background: url(//localhost/wp-content/plugins/gtranslate/arrow_down.png) 146px center no-repeat;
        color: #666666;
        padding: 3px 5px;
        width: 151px;
    }
    ...
    .switcher .selected a.open {
        background-image: url(//localhost/wp-content/plugins/gtranslate/arrow_up.png)
    }

    .switcher .selected a:hover {
        background: #F0F0F0 url(//localhost/wp-content/plugins/gtranslate/arrow_down.png) 146px center no-repeat;
    }
...
<div class="switcher notranslate">
    <div class="selected">
        <a href="#" onclick="return false;"><img src="//localhost/wp-content/plugins/gtranslate/flags/16/en.png" height="16" width="16" alt="en" /> English</a>
    </div>
    <div class="option">
