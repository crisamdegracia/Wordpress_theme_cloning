...
<section id="menu-page-x">
	...
	<div id="menu_section_container" class="container">
		...
		<!--The little ex. Appetizer-->
			...
			<h1 class="menu-header-bg" style="background-image: url(<?php bloginfo('template_directory')?>/assets/img/slider1.jpg);"> <?php the_title() ; ?></h1>
		...
		<div class="menu-category-body  row justify-content-center">
			...
			<div class="card col-6 col-sm-6 col-md-4  col-lg-3  my-1 menu-category-content">
			...
			<div class="card col-6 col-sm-6 col-md-4  col-lg-3  my-1 menu-category-content">
				...
				<img class="card-img" src="<?php echo get_field('product_image_2')['url'] ?>" alt="Card image">
				<?php } else { ?>
